...
**⬇️ Install package:** [OJS 3.5](https://github.com/OJSBR/staticEditorialTeam/releases/download/1.0.0.1/staticEditorialTeam-1.0.0.1.tar.gz) — or browse all [Releases](../../releases).
