...
**⬇️ Install package:** [OJS 3.5](https://github.com/OJSBR/staticEditorialTeam/releases/download/1.0.0.0/staticEditorialTeam-1.0.0.0.tar.gz) — or browse all [Releases](../../releases).
