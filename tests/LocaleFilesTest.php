...
/**
 * @file plugins/generic/staticEditorialTeam/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.staticEditorialTeam\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
