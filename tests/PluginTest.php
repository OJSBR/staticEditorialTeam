...
/**
 * @file plugins/generic/staticEditorialTeam/tests/PluginTest.php
 *
...
class PluginTest extends PKPTestCase
{
    ...
    {
        return [
            \APP\plugins\generic\staticEditorialTeam\StaticEditorialTeamPlugin::class,
            \APP\plugins\generic\staticEditorialTeam\StaticEditorialTeamSettingsForm::class,
        ];
    }
